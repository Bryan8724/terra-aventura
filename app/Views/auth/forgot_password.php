    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root, [data-theme="light"] {
            ...
            --card-bg:    #ffffff; --card-bd: rgba(79,70,229,.12);
            --card-sh:    0 20px 60px rgba(79,70,229,.1);
            --input-bg:   #f8fafc; --input-bd: #e2e8f0; --input-foc: #4f46e5;
            --input-ring: rgba(79,70,229,.15);
            --text: #1e293b; --text-sub: #64748b; --text-lbl: #475569; --ph: #94a3b8;
            --link: #4f46e5; --link-h: #3730a3;
            --btn: linear-gradient(135deg,#4f46e5,#7c3aed); --btn-sh: rgba(79,70,229,.35);
            --sep: #e2e8f0; --orb-op: .35;
            --info-bg: rgba(79,70,229,.06); --info-bd: rgba(79,70,229,.12);
        }
        [data-theme="dark"] {
            --bg:         linear-gradient(135deg,#0f172a 0%,#1a1f3a 50%,#0f1a2e 100%);
            --card-bg:    rgba(30,41,59,.96); --card-bd: rgba(255,255,255,.07);
            --card-sh:    0 25px 60px rgba(0,0,0,.55);
            --input-bg:   rgba(255,255,255,.06); --input-bd: rgba(255,255,255,.1); --input-foc: #6366f1;
            --input-ring: rgba(99,102,241,.2);
            --text: #f1f5f9; --text-sub: #94a3b8; --text-lbl: #94a3b8; --ph: #475569;
            --link: #818cf8; --link-h: #a5b4fc;
            --btn: linear-gradient(135deg,#4f46e5,#6d28d9); --btn-sh: rgba(79,70,229,.4);
            --sep: rgba(255,255,255,.08); --orb-op: .1;
            --info-bg: rgba(99,102,241,.08); --info-bd: rgba(99,102,241,.15);
        }
        ...
        .ok   { background:rgba(22,163,74,.1); border:1px solid rgba(22,163,74,.25); border-radius:.75rem;
                padding:.75rem 1rem; font-size:.875rem; text-align:center; margin-bottom:1rem; color:#16a34a; }
        [data-theme="dark"] .ok,
        [data-theme="system"] .ok { color:#86efac; }
        .info { background:var(--info-bg); border:1px solid var(--info-bd); border-radius:.875rem;
                padding:.875rem 1rem; font-size:.82rem; color:var(--text-sub); line-height:1.5; margin-bottom:1rem; }
...
<div class="card">
    ...
    <form method="post" action="/forgot-password" class="form">
        <div class="field">
            <label class="lbl" for="email">Adresse email</label>
            <input type="email" id="email" name="email" required autocomplete="email"
                   class="inp" placeholder="votre@email.fr">
        </div>
